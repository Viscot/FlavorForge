...
class _FavoritePageState extends State<FavoritePage> {
  ...
  Future<void> fetchFavoriteRecipes() async {
    ...
    for (String recipeId in favoriteRecipeIds) {
      // Ambil resep berdasarkan ID dari Firestore
  ...
  Future<void> toggleFavoriteStatus(Recipe recipe) async {
    ...
    // Reference to the favorite document in the 'favorites' collection
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: favoriteRecipes.isEmpty
          ? Center(
              child: Text('tidak ada menu favorite'),
            )
          : ListView.builder(
